...
def instructions():
    ...
    needed and gained for each category. The information can be either be
    entered manually, or read in from a CSV file.
    ...
    ======================
    You will first be asked to enter the names of each category (column).
    After typing in the last column name, type "done" on the
    next line to start entering data.  This program accepts up to 20
    categories.
    '''
    inst2 = '''
    Data is entered for each column name you entered.
    To enter the data, type in the minimum number of characters needed
